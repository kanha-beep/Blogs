          ...
          <div className="col-12 col-md-10 col-lg-8">
            ...
            <div className="row g-4">
              <div className="col-12 col-sm-6 col-lg-3">
                <div className="card border-0 shadow-sm h-100 text-center" style={{ cursor: 'pointer' }} onClick={() => navigate('/')}>
                  <div className="card-body py-4">
                    ...
                    <p className="text-muted small mb-0">Browse all posts</p>
                  </div>
                </div>
              </div>

              <div className="col-12 col-sm-6 col-lg-3">
                <div className="card border-0 shadow-sm h-100 text-center" style={{ cursor: 'pointer' }} onClick={() => navigate('/blogsform')}>
                  <div className="card-body py-4">
                    <div className="mb-3">
              ...
              <div className="col-12 col-sm-6 col-lg-3">
                <div className="card border-0 shadow-sm h-100 text-center" style={{ cursor: 'pointer' }} onClick={() => navigate('/profile')}>
                  <div className="card-body py-4">
                    <div className="mb-3">
              ...
              <div className="col-12 col-sm-6 col-lg-3">
                <div className="card border-0 shadow-sm h-100 text-center" style={{ cursor: 'pointer' }} onClick={() => navigate('/contacts')}>
                  <div className="card-body py-4">
                    <div className="mb-3">
